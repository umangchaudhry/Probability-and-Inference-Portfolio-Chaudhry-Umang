...
plot(x=seq(100,1000,100), y=walk_out_money1, xlab = "Number of Plays", ylab = "Earnings", type = "o")
```
...
plot(x=seq(10,100,10), y=walk_out_money2, xlab = "Number of Plays", ylab = "Earnings", type = "o")
```
...
plot(x=seq(10,100,10), y=walk_out_money3, xlab = "Number of Plays", ylab = "Earnings", type = "o")
```
...
plot(x=seq(10,100,10), y=walk_out_money4, xlab = "Number of Plays", ylab = "Earnings", type = "o")
```
